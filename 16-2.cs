void Main()
{
	...
	Sue 500: pomeranians: 10, cats: 3, vizslas: 5".Split(new[] { Environment.NewLine}, StringSplitOptions.RemoveEmptyEntries);
	...
	sues.Where(sue => known.Keys.All(key =>
		{
